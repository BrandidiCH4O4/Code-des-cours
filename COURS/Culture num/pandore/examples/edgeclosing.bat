...
set TMPFILE=b.pan c.pan d.pan e.pan f.pan g.pan i.pan j.pan h.pan extensionconic_out.pan extensionrect_out.pan out.pan
...
echo - Performing edge closing using iconic extension of the end points
   ...
   pvisu  extensionconic_out.pan

echo - Performing edge closing using rectangular extension of the end points
   pcontourextensionconic 4 e.pan extensionrect_out.pan
   pvisu  extensionrect_out.pan

echo - Performing edge closing using distance to the nearest contour
   psobel tangram.pan b.pan
   ...
   pskeletonization c.pan d.pan 
   pboundarylabeling d.pan e.pan
   pboundary 8 e.pan out.pan
   pvisu out.pan
