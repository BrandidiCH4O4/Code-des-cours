...
set TMPFILE=i1.pan i2.pan i3.pan out.pan

echo - Performs an edge detection using the DOG algorithm (Difference of Gaussian)

   pexponentialfiltering 0.3 tangram.pan i1.pan
