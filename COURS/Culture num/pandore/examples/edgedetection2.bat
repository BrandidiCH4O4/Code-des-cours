...
rem
rem @(#)edgedetection2.bat
rem 
rem (C)Régis Clouard - 2006-09-06
rem

set TMPFILE=a.pan deriche.pan shen.pan


echo - Performing edge detection using Shen algorithms
   pshen 1 tangram.pan a.pan
   pbinarization 10 1e30 a.pan shen.pan
   pvisu shen.pan

echo - Performing edge detection using Deriche algorithm
