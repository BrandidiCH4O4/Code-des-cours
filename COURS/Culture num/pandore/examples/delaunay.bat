...
rem @(#)delaunay.bat
rem
rem (C)Regis Clouard -  2006-09-07
rem

set TMPFILE=a.pan b.pan c.pan d.pan e.pan delaunay.pan voronoi.pan

echo - Calculating the Delaunay graph from the centers of mass of tangram pieces
pbinarization 96 1e30 tangram.pan a.pan
plabeling 8 a.pan b.pan
pfillhole 8 b.pan c.pan
pcenterofmass c.pan d.pan
pdelaunay d.pan delaunay.pan

pvisu delaunay.pan

echo - Calculating the Voronoi diagram from the centers of mass of tangram pieces
pvoronoi d.pan voronoi.pan e.pan
pvisu voronoi.pan
